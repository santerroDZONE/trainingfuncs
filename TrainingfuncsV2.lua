...
local autoads_checkbox = tf.char(true)
        ...
        if selectedTab == 1 then
            imgui.BeginGroup()
                imgui.BeginChild('Settings', imgui.ImVec2(0, 0), true)
                    ...
                    imgui.SameLine("( ? )", u8"Автореклама. Задержка 120 секунд.")
                imgui.EndChild()
            imgui.EndGroup()
        end
...
function apply_custom_style()
    ...
    imgui.GetStyle().style.WindowPadding = imgui.ImVec2(8, 8)
    imgui.GetStyle().style.WindowRounding = 6
    imgui.GetStyle().style.ChildWindowRounding = 5
    imgui.GetStyle().style.FramePadding = imgui.ImVec2(5, 3)
    imgui.GetStyle().style.FrameRounding = 3.0
    imgui.GetStyle().style.ItemSpacing = imgui.ImVec2(5, 4)
    imgui.GetStyle().style.ItemInnerSpacing = imgui.ImVec2(4, 4)
    imgui.GetStyle().style.IndentSpacing = 21
    imgui.GetStyle().style.ScrollbarSize = 10.0
    imgui.GetStyle().style.ScrollbarRounding = 13
    imgui.GetStyle().style.GrabMinSize = 8
    imgui.GetStyle().style.GrabRounding = 1
    imgui.GetStyle().style.WindowTitleAlign = imgui.ImVec2(0.5, 0.5)
    imgui.GetStyle().style.ButtonTextAlign = imgui.ImVec2(0.5, 0.5)
